              ...
              <div class="modal-body">
                <form id="formRegistroUsuarios" class="needs-validation" novalidate>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="txt_documento" aria-describedby="emailHelp" required>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="txt_nombres" aria-describedby="emailHelp" required>
                    <div class="invalid-feedback">
                      Este campo es Requerido.
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="txt_apellidos" aria-describedby="emailHelp" required>
                    <div class="invalid-feedback">
                      Este campo es Requerido.
                    </div>
                  </div>
