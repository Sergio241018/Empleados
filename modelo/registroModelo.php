...
class registroModelo {
    public static function mdlRegistroModelo($documento, $nombre, $apellido, $email, $password, $url, $tipo_usuario_idtipo_usuario) {
        $mensaje = array();

        $password = '123456';

        $url = "archivos/user-1.jpg"; // Asignación fija de URL
